...
//
//    private static SimpleClientHandler simpleClientHandler = new SimpleClientHandler();
//
...
//            });
//            /** 开启客户端监听*/
//            channelFuture = b.connect("127.0.0.1", 8868).sync();
//            /**等待数据直到客户端关闭*/
//
...
//    }
//
//    public static ResponseBean sendSync(RequsetBean requsetBean) {
//
...
//    }
//
//    private static ResponseBean getResult(String resourceId) {
